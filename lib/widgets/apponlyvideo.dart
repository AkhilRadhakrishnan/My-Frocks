...
class WidgetAppOnlyVideo extends StatefulWidget {
  @override
  _WidgetAppOnlyVideoState createState() => _WidgetAppOnlyVideoState();
}

class _WidgetAppOnlyVideoState extends State<WidgetAppOnlyVideo> {
  MVideos model;
  ...
  Widget build(BuildContext context) {
    return Container(
      child: FutureBuilder<Result>(
        future: _apiResponse.getVideos("22"),
